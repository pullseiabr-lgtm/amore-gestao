      ...
      <aside className={`sidebar${mobileOpen ? ' mobile-open' : ''}`}>
        <div className="sb-logo">
          <div className="sb-icon">
            {isFlow
              ? <svg viewBox="0 0 38 22" width="24" height="13" aria-label="Flow"><path d="M3 4 C6 4 5 18 8 18 C11 18 10 4 13 4 C16 4 15 18 18 18 C21 18 20 4 23 4 C26 4 25 18 28 18 C31 18 32 6 34 6" fill="none" stroke="#fff" strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round"/></svg>
              : theme.logo_url
