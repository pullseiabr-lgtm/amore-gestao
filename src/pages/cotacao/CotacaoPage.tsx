  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 6, marginBottom: 12, flexWrap: 'wrap' }}>
        {([['reqs', '📋 Requisições / cotar'], ['respondidas', '📥 Cotações respondidas'], ['fornecedores', '🏷️ Fornecedores'], ['relatorios', '📊 Relatórios']] as const).map(([k, l]) => (
      ...
      {vista === 'respondidas' ? (
        ...
        <RelatoriosGerenciais loja={loja} toast={toast} />
      ) : (<>
